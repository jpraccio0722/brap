...
const linkDecoration = Decoration.mark({ class: "cm-scree-help-link" });
...
function render(b: Builtin): HTMLElement {
  ...
  hint.className = "cm-scree-help-hint";
...
const helpTheme = EditorView.baseTheme({
  ...
  ".cm-scree-help-signature": { fontFamily: "monospace", fontWeight: "bold" },
  ".cm-scree-help-doc": {
    marginTop: "4px",
  ...
  ".cm-scree-help-link": { textDecoration: "underline", cursor: "pointer" },
});
